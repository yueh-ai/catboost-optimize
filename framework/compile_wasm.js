...
if (!options.input || !options.output) {
    console.error('Usage: node simple_compile_wasm.js --input <cpp_file> --output <js_output> [--flags "-O3"]');
    process.exit(1);
}
...
// Build emcc command - compile the C++ file directly without wrapper
